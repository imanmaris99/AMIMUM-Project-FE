...
// Sesuai dengan struktur API backend
const dummyData = {
  articles: {
    status_code: 200,
  ...
  categories: {
    status_code: 200,
    message: "All list of tag categories has been success access",
    data: [
      { 
        id: 1, 
        name: "Herbal", 
        description_list: ["Produk herbal alami berkualitas tinggi", "Menggunakan bahan-bahan pilihan terbaik"],
        created_at: "2024-01-01T00:00:00Z" 
      },
      { 
        id: 2, 
        name: "Rempah", 
        description_list: ["Rempah-rempah asli Indonesia", "Kualitas premium untuk masakan"],
        created_at: "2024-01-01T00:00:00Z" 
      },
      { 
        id: 3, 
        name: "Teh", 
        description_list: ["Teh premium dari perkebunan terbaik", "Kualitas internasional"],
        created_at: "2024-01-01T00:00:00Z" 
      },
      { 
        id: 4, 
        name: "Madu", 
        description_list: ["Madu murni asli dari lebah", "Khasiat alami tanpa campuran"],
        created_at: "2024-01-01T00:00:00Z" 
      },
      { 
        id: 5, 
        name: "Jamu", 
        description_list: ["Jamu tradisional berkhasiat", "Resep warisan leluhur"],
        created_at: "2024-01-01T00:00:00Z" 
      },
      { 
        id: 6, 
