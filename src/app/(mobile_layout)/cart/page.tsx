...
import { recalculateCartTotals, removeCartItem, toggleSelectAll, updateCartItem } from "@/helper/cart";
...
const Cart = () => {
  ...
  return (
    <>
      <CartUI cartResponse={cartResponse} isCartListLoading={isCartListLoading} selectAll={selectAll} onToggleAllActivation={handleToggleAllActivation} onUpdateCart={handleUpdateCart} onRemoveItem={handleRemoveItem} />
    </>
  );
};
